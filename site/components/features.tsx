        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2 text-gray-950">Correct the text</h4>
              <p className="text-lg text-gray-800 text-center">AI will correct the grammar of your message and take into account the nuances of the language.</p>
            </div>
            ...
            <svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              <h4 className="h4 mb-2 text-gray-950">Translate the text</h4>
              <p className="text-lg text-gray-800 text-center">AI will translate the text to another language and make it sound natural.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2 text-center text-gray-950">Get an explanation of the text</h4>
              <p className="text-lg text-gray-800 text-center">AI will clarify the meaning of the text that you do not understand.</p>
            </div>
