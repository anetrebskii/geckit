...
| Questions on the board (new) | A "Questions" group under the column's cards, one row per open question with its dot, title and last line, and "Each is forgotten 5 minutes after its last answer." under it. Pressing a row opens the question like a conversation | While any question is open, in every column |
